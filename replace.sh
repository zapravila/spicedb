...
find pkg/proto  -type f | xargs sed -i '' 's/v12\ \"github\.com\/authzed\/spicedb\/pkg\/proto\/authzed\/api\/v1\"/v12\ \"github\.com\/zapravila\/authzed-go\/proto\/authzed\/api\/v1\"/g'
