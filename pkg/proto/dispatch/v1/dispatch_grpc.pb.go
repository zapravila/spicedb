...
func (c *dispatchServiceClient) DispatchReachableResources(ctx context.Context, in *DispatchReachableResourcesRequest, opts ...grpc.CallOption) (DispatchService_DispatchReachableResourcesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DispatchService_ServiceDesc.Streams[0], DispatchService_DispatchReachableResources_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &dispatchServiceDispatchReachableResourcesClient{ClientStream: stream}
...
func (c *dispatchServiceClient) DispatchLookupResources(ctx context.Context, in *DispatchLookupResourcesRequest, opts ...grpc.CallOption) (DispatchService_DispatchLookupResourcesClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DispatchService_ServiceDesc.Streams[1], DispatchService_DispatchLookupResources_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &dispatchServiceDispatchLookupResourcesClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *dispatchServiceClient) DispatchLookupSubjects(ctx context.Context, in *DispatchLookupSubjectsRequest, opts ...grpc.CallOption) (DispatchService_DispatchLookupSubjectsClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DispatchService_ServiceDesc.Streams[2], DispatchService_DispatchLookupSubjects_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &dispatchServiceDispatchLookupSubjectsClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func _DispatchService_DispatchReachableResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DispatchServiceServer).DispatchReachableResources(m, &dispatchServiceDispatchReachableResourcesServer{ServerStream: stream})
}
...
func _DispatchService_DispatchLookupResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DispatchServiceServer).DispatchLookupResources(m, &dispatchServiceDispatchLookupResourcesServer{ServerStream: stream})
}
...
func _DispatchService_DispatchLookupSubjects_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DispatchServiceServer).DispatchLookupSubjects(m, &dispatchServiceDispatchLookupSubjectsServer{ServerStream: stream})
}
