...
var file_google_api_expr_v1beta1_decl_proto_rawDesc = []byte{
	...
	0x42, 0x09, 0x44, 0x65, 0x63, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x48, 0x67,
...
func file_google_api_expr_v1beta1_decl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_api_expr_v1beta1_decl_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Decl); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_api_expr_v1beta1_decl_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_api_expr_v1beta1_decl_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_api_expr_v1beta1_decl_proto_msgTypes[3].Exporter = func(v any, i int) any {
