...
func (m *Expr) validate(all bool) error {
	...
	case *Expr_ConstExpr:
		...
		if all {
			switch v := interface{}(m.GetConstExpr()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
		...
		} else if v, ok := interface{}(m.GetConstExpr()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
...
func (m *SourceInfo) validate(all bool) error {
	...
	{
		sorted_keys := make([]int64, len(m.GetMacroCalls()))
		i := 0
		for key := range m.GetMacroCalls() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetMacroCalls()[key]
			_ = val

			// no validation rules for MacroCalls[key]

			if all {
				switch v := interface{}(val).(type) {
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, SourceInfoValidationError{
							field:  fmt.Sprintf("MacroCalls[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
				...
				if err := v.Validate(); err != nil {
					return SourceInfoValidationError{
						field:  fmt.Sprintf("MacroCalls[%v]", key),
						reason: "embedded message failed validation",
						cause:  err,
					}
...
func (m *Expr_CreateStruct_Entry) validate(all bool) error {
	...
	// no validation rules for OptionalEntry
...
// Validate checks the field values on SourceInfo_Extension with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SourceInfo_Extension) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SourceInfo_Extension with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SourceInfo_ExtensionMultiError, or nil if none found.
func (m *SourceInfo_Extension) ValidateAll() error {
	return m.validate(true)
}

func (m *SourceInfo_Extension) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SourceInfo_ExtensionValidationError{
					field:  "Version",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return SourceInfo_ExtensionValidationError{
				field:  "Version",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return SourceInfo_ExtensionMultiError(errors)
	}

	return nil
}

// SourceInfo_ExtensionMultiError is an error wrapping multiple validation
// errors returned by SourceInfo_Extension.ValidateAll() if the designated
// constraints aren't met.
type SourceInfo_ExtensionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SourceInfo_ExtensionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SourceInfo_ExtensionMultiError) AllErrors() []error { return m }

// SourceInfo_ExtensionValidationError is the validation error returned by
// SourceInfo_Extension.Validate if the designated constraints aren't met.
type SourceInfo_ExtensionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SourceInfo_ExtensionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SourceInfo_ExtensionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SourceInfo_ExtensionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SourceInfo_ExtensionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SourceInfo_ExtensionValidationError) ErrorName() string {
	return "SourceInfo_ExtensionValidationError"
}

// Error satisfies the builtin error interface
func (e SourceInfo_ExtensionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSourceInfo_Extension.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SourceInfo_ExtensionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SourceInfo_ExtensionValidationError{}

// Validate checks the field values on SourceInfo_Extension_Version with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SourceInfo_Extension_Version) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SourceInfo_Extension_Version with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SourceInfo_Extension_VersionMultiError, or nil if none found.
func (m *SourceInfo_Extension_Version) ValidateAll() error {
	return m.validate(true)
}

func (m *SourceInfo_Extension_Version) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SourceInfo_Extension_VersionMultiError(errors)
	}

	return nil
}

// SourceInfo_Extension_VersionMultiError is an error wrapping multiple
// validation errors returned by SourceInfo_Extension_Version.ValidateAll() if
// the designated constraints aren't met.
type SourceInfo_Extension_VersionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SourceInfo_Extension_VersionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SourceInfo_Extension_VersionMultiError) AllErrors() []error { return m }

// SourceInfo_Extension_VersionValidationError is the validation error returned
// by SourceInfo_Extension_Version.Validate if the designated constraints
// aren't met.
type SourceInfo_Extension_VersionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SourceInfo_Extension_VersionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SourceInfo_Extension_VersionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SourceInfo_Extension_VersionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SourceInfo_Extension_VersionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SourceInfo_Extension_VersionValidationError) ErrorName() string {
	return "SourceInfo_Extension_VersionValidationError"
}

// Error satisfies the builtin error interface
func (e SourceInfo_Extension_VersionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSourceInfo_Extension_Version.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SourceInfo_Extension_VersionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SourceInfo_Extension_VersionValidationError{}
